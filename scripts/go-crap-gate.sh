...
OS_INTEGRATION_EXEMPT = {
    ("internal/process/daemon.go", "*daemon.wait", 514),
    ("internal/procutil/procutil_linux.go", "platformCPUTime", 67),
    ("internal/monitor/health_monitor.go", "*HealthMonitor.isProcessAlive", 727),
    ("internal/ownership/ownership.go", "Align", 83),
    ("cmd/system.go", "installUpdatedBinary", 1588),
    ("internal/process/daemon.go", "StartStandaloneDaemon", 55),
    ("internal/process/daemon.go", "bootService", 124),
    ("internal/process/daemon.go", "newStandaloneDaemon", 343),
